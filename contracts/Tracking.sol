...
contract Tracking {
    ...
    constructor() {
     ...
     function createShipment(address _receiver, uint256 _pickupTime, uint256 _price) public payable {
        ...
        Shipment memory shipment = Shipment(msg.sender, _receiver, _pickupTime, 0, _price, ShipmentStatus.PENDING, false);
    ...
    function getShipment(address _sender, uint256 _index) public view returns (address, address, uint256, uint256, uint256, ShipmentStatus, bool) {
        ...
        return (shipment.sender, shipment.receiver, shipment.pickupTime, shipment.deliveryTime, shipment.price, shipment.status, shipment.isPaid);
    }
